...
## About Me
👨‍💻 Admin Sys & DevOps | 🚀 Objectif Ingénieur Cloud

Passionné par l'écosystème cloud, je développe activement mes compétences en :
...
🔎 En recherche active d'une alternance pour approfondir mes acquis et avoir la tête dans les ☁️ (du cloud !) 


## Skill stack
[![My Skills](https://skillicons.dev/icons?i=azure,gcp,docker,git,gitlab,terraform,ansible,python,kubernetes,&theme=light)](https://skillicons.dev)
